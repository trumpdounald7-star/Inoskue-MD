...
const canWel = await new canvafy.WelcomeLeave()
    .setAvatar(pp)
    .setBackground("image", "https://files.catbox.moe/tynb2g.jpg")
    .setTitle("Welcome")
    ...
    this.sendMessage(id, {
        ...
        mentionedJid: [user],
            externalAdReply: {
                ...
                mediaType: 1,
                mediaUrl: 'https://files.catbox.moe/tynb2g.jpg',
                renderLargerThumbnail: true,
...
let msg = {
        ...
        gconly: `📢 لا يمكنك الوصول إلى ميزة ❗\nانضم إلى مجموعة Inoskue Bot لتتمكن من الوصول\n\n> ${global.url.sgc}`,
